...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AbstractActivity.activity_type'
        db.add_column(u'core_abstractactivity', 'activity_type',
                      self.gf('django.db.models.fields.CharField')(default='DiscussionActivity', max_length=100),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AbstractActivity.activity_type'
        db.delete_column(u'core_abstractactivity', 'activity_type')
    ...
    models = {
        ...
        u'core.abstractactivity': {
            ...
            'activity_type': ('django.db.models.fields.CharField', [], {'default': "'DiscussionActivity'", 'max_length': '100'}),
