...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Video.modified'
        db.alter_column(u'videocore_video', 'modified', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2014, 4, 29, 0, 0)))

        # Changing field 'Video.created'
        db.alter_column(u'videocore_video', 'created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2014, 4, 29, 0, 0)))

    def backwards(self, orm):

        # Changing field 'Video.modified'
        db.alter_column(u'videocore_video', 'modified', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, null=True))

        # Changing field 'Video.created'
        db.alter_column(u'videocore_video', 'created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True))
