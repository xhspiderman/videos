...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field channel on 'Video'
        m2m_table_name = db.shorten_name(u'videocore_video_channel')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('video', models.ForeignKey(orm[u'videocore.video'], null=False)),
            ('channel', models.ForeignKey(orm[u'videocore.channel'], null=False))
        ))
        db.create_unique(m2m_table_name, ['video_id', 'channel_id'])
    ...
    def backwards(self, orm):
        ...
        # Removing M2M table for field channel on 'Video'
        db.delete_table(db.shorten_name(u'videocore_video_channel'))
    ...
    models = {
        ...
        u'videocore.video': {
            ...
            'channel': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': u"orm['videocore.Channel']", 'null': 'True', 'blank': 'True'}),
